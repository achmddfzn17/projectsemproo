...
@section('title', $kegiatan->nama_kegiatan . ' - Karang Taruna')
...
<div class="bg-blue-50 border-b border-blue-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="flex items-center text-sm text-gray-600">
            ...
            <a href="{{ route('kegiatan.index') }}" class="hover:text-blue-600">Kegiatan</a>
            <svg class="w-4 h-4 mx-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
            </svg>
...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <!-- Back Button -->
    <a href="{{ route('kegiatan.index') }}" class="inline-flex items-center text-blue-600 hover:text-blue-700 font-semibold mb-8 group">
    ...
    <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-blue-100">
        ...
        <div class="relative h-96">
            @if($kegiatan->foto)
            <img src="{{ asset('storage/' . $kegiatan->foto) }}" alt="{{ $kegiatan->nama_kegiatan }}" class="w-full h-full object-cover">
            @else
        ...
        <!-- Content -->
        <div class="p-10">
            <h1 class="text-4xl font-extrabold text-gray-800 mb-8">{{ $kegiatan->nama_kegiatan }}</h1>
                ...
                <div class="bg-blue-50 rounded-2xl p-6 border border-blue-100">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="font-bold text-gray-800">{{ $kegiatan->tanggal_mulai->format('d F Y') }}</p>
                            @if($kegiatan->tanggal_selesai)
                            <p class="text-sm text-gray-600 mt-1">s/d {{ $kegiatan->tanggal_selesai->format('d F Y') }}</p>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-blue-50 rounded-2xl p-6 border border-blue-100">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="font-bold text-gray-800">{{ $kegiatan->penanggung_jawab }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-blue-50 rounded-2xl p-6 border border-blue-100">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="font-bold text-gray-800">{{ $kegiatan->jumlah_peserta }} Orang</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-4">
                            <div>
                                ...
                                <p class="text-2xl font-black text-purple-600">{{ $kegiatan->sisaKuota() }} / {{ $kegiatan->kuota_peserta }}</p>
                            </div>
