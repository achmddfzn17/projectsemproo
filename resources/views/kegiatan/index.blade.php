    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-blue-100">
            ...
            <div class="relative overflow-hidden h-56">
                @if($item->foto)
                <img src="{{ asset('storage/' . $item->foto) }}" alt="{{ $item->nama_kegiatan }}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                @else
            ...
            <div class="p-6">
                ...
                <!-- Button -->
                <a href="{{ route('kegiatan.detail', $item->id) }}" class="inline-flex items-center text-blue-600 hover:text-blue-700 font-bold group-hover:gap-2 transition-all">
                    Lihat Detail
...
<div class="bg-gradient-to-r from-blue-600 to-blue-700 py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            <a href="{{ route('tentang') }}" class="bg-white text-blue-600 px-8 py-4 rounded-xl font-bold hover:bg-blue-50 transition-all transform hover:scale-105 shadow-2xl">
                Tentang Kami
            </a>
