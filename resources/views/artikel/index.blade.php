...
@section('title', 'Artikel - Karang Taruna')
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    ...
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-blue-100 mb-16">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-0">
            ...
            <div class="md:col-span-3 p-10 flex flex-col justify-center">
                ...
                <a href="{{ route('artikel.detail', $featured->slug) }}" class="inline-flex items-center text-blue-600 hover:text-blue-700 font-bold text-lg group">
                    Baca Artikel
    ...
    <div class="flex justify-between items-center mb-12">
        ...
        <div class="text-sm text-gray-600">
            Menampilkan {{ $artikel->count() }} dari {{ $artikel->total() }} artikel
        </div>
    </div>
    
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        @forelse($artikel->skip(1) as $item)
        <article class="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-blue-100">
            ...
            <div class="p-6">
                ...
                <!-- Read More -->
                <a href="{{ route('artikel.detail', $item->slug) }}" class="inline-flex items-center text-blue-600 hover:text-blue-700 font-bold group-hover:gap-2 transition-all">
                    Baca Artikel
