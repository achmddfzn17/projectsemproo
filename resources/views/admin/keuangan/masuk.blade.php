        ...
        <div class="bg-white rounded-2xl shadow-lg border border-blue-200">
            <div class="p-6 border-b border-blue-200">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.keuangan.export-pdf', ['jenis' => 'masuk']) }}" class="bg-blue-100 text-blue-700 px-4 py-2 rounded-lg text-sm font-semibold hover:bg-blue-200 transition-all flex items-center gap-1">
