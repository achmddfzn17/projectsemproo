                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="date" name="tanggal" value="{{ old('tanggal', now()->format('Y-m-d')) }}" 
                            class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-red-500 focus:border-transparent @error('tanggal') border-red-500 @enderror">
                        @error('tanggal')
                    ...
                    <div>
                        ...
                        <select name="kategori_id" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-red-500 focus:border-transparent @error('kategori_id') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <textarea name="keterangan" rows="3" 
                            class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-red-500 focus:border-transparent @error('keterangan') border-red-500 @enderror"
                            placeholder="Contoh: Pembelian ATK untuk kegiatan">{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="jumlah" value="{{ old('jumlah') }}" min="1"
                            class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-red-500 focus:border-transparent @error('jumlah') border-red-500 @enderror"
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Penerima / Vendor</label>
                        <input type="text" name="penerima" value="{{ old('penerima') }}"
                            class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-red-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="file" name="bukti_transaksi" accept="image/*"
                            class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-red-500 focus:border-transparent @error('bukti_transaksi') border-red-500 @enderror">
            ...
            <div class="mt-6 pt-6 border-t border-gray-200">
                ...
                <form action="{{ route('admin.keuangan.kategori.store') }}" method="POST" class="flex gap-2">
                    ...
                    <input type="text" name="nama_kategori" placeholder="Nama kategori"
                        class="flex-1 px-3 py-2 text-sm rounded-lg border border-gray-200 focus:ring-2 focus:ring-red-500">
                    <button type="submit" class="bg-red-100 text-red-700 px-3 py-2 rounded-lg text-sm font-semibold hover:bg-red-200">
                        +
                    </button>
                </form>
            </div>
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-12">
                                    <div class="flex flex-col items-center text-gray-500">
                                        ...
                                        <p class="font-semibold">Belum ada data kas keluar</p>
