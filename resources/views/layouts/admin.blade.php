    ...
    <aside id="sidebar" class="fixed lg:static inset-y-0 left-0 z-50 w-64 bg-white border-r border-blue-100 shadow-lg sidebar-transition -translate-x-full lg:translate-x-0 overflow-y-auto">
        <div class="p-6">
            ...
            <nav class="space-y-1">
                ...
                <a href="{{ route('admin.sus.daftar') }}" class="flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('admin.sus.*') ? 'bg-green-600 text-white shadow-lg' : 'text-gray-700 hover:bg-green-50' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
