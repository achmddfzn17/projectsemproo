...
<div class="mb-6">
    <a href="<?php echo e(route('admin.berita.index')); ?>" class="text-blue-600 hover:text-blue-700 font-semibold">← Kembali</a>
</div>
...
<div class="bg-white rounded-2xl shadow-lg p-8 border border-blue-100">
    ...
    <form method="POST" action="<?php echo e(route('admin.berita.update', $berita->id)); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="space-y-6">
            <div>
                ...
                <input type="text" name="judul" value="<?php echo e(old('judul', $berita->judul)); ?>" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="slug" value="<?php echo e(old('slug', $berita->slug)); ?>" 
                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
                       required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <?php if($berita->gambar): ?>
                    <img src="<?php echo e(asset('storage/' . $berita->gambar)); ?>" class="w-48 h-32 object-cover rounded-xl mb-3">
                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mt-8 flex space-x-4">
            ...
            <a href="<?php echo e(route('admin.berita.index')); ?>" class="bg-gray-200 text-gray-700 px-8 py-3 rounded-xl hover:bg-gray-300 transition-all font-semibold">
                Batal
            </a>
        </div>
    </form>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\projectsempro\resources\views/admin/berita/edit.blade.php ENDPATH**/ ?>