...
<div class="bg-white rounded-2xl shadow-lg p-8 border border-blue-100">
    ...
    <form method="POST" action="<?php echo e(route('admin.berita.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\projectsempro\resources\views/admin/berita/create.blade.php ENDPATH**/ ?>