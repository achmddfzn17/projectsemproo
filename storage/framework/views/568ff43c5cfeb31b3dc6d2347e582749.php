...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Karang Taruna'); ?></title>
    <script src="https://cdn.tailwindcss.com"></script>
    <script src="https://code.iconify.design/iconify-icon/1.0.8/iconify-icon.min.js"></script>
    <link rel="stylesheet" href="<?php echo e(asset('css/custom-animations.css')); ?>">
    <style>
        /* Smooth Scrolling */
        html {
            ...
            <div class="flex justify-between h-20">
                ...
                <div class="hidden md:flex items-center space-x-2">
                    ...
                    <a href="<?php echo e(route('home')); ?>"
                        class="px-4 py-2 text-gray-700 hover:text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transition-all flex items-center gap-1 <?php echo e(request()->routeIs('home') ? 'bg-blue-50 text-blue-600' : ''); ?>">
                        <iconify-icon icon="mdi:home" class="text-lg"></iconify-icon> Beranda
                    </a>
                    <a href="<?php echo e(route('tentang')); ?>"
                        class="px-4 py-2 text-gray-700 hover:text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transition-all flex items-center gap-1 <?php echo e(request()->routeIs('tentang') ? 'bg-blue-50 text-blue-600' : ''); ?>">
                        <iconify-icon icon="mdi:information" class="text-lg"></iconify-icon> Tentang
                    </a>
                    <a href="<?php echo e(route('kegiatan.index')); ?>"
                        class="px-4 py-2 text-gray-700 hover:text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transition-all flex items-center gap-1 <?php echo e(request()->routeIs('kegiatan.*') ? 'bg-blue-50 text-blue-600' : ''); ?>">
                        <iconify-icon icon="mdi:calendar" class="text-lg"></iconify-icon> Kegiatan
                    </a>
                    <a href="<?php echo e(route('berita.index')); ?>"
                        class="px-4 py-2 text-gray-700 hover:text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transition-all flex items-center gap-1 <?php echo e(request()->routeIs('berita.*') ? 'bg-blue-50 text-blue-600' : ''); ?>">
                        <iconify-icon icon="mdi:newspaper" class="text-lg"></iconify-icon> Berita
                    </a>
                    <a href="<?php echo e(route('artikel.index')); ?>"
                        class="px-4 py-2 text-gray-700 hover:text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transition-all flex items-center gap-1 <?php echo e(request()->routeIs('artikel.*') ? 'bg-blue-50 text-blue-600' : ''); ?>">
                        <iconify-icon icon="mdi:file-document" class="text-lg"></iconify-icon> Artikel
                    </a>
                    <a href="<?php echo e(route('galeri.index')); ?>"
                        class="px-4 py-2 text-gray-700 hover:text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transition-all flex items-center gap-1 <?php echo e(request()->routeIs('galeri.*') ? 'bg-blue-50 text-blue-600' : ''); ?>">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('anggota.login')); ?>"
                            class="ml-2 bg-blue-600 text-white px-6 py-2 rounded-xl font-bold hover:bg-blue-700 hover:shadow-lg transform hover:scale-105 transition-all flex items-center gap-1">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="<?php echo e(route('tentang')); ?>"
                                class="text-gray-300 hover:text-blue-400 transition flex items-center"><span
                                    class="mr-2">→</span> Tentang Kami</a></li>
                        <li><a href="<?php echo e(route('kegiatan.index')); ?>"
                                class="text-gray-300 hover:text-blue-400 transition flex items-center"><span
            ...
            <div class="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-400 text-sm mb-4 md:mb-0">
                    &copy; <?php echo e(date('Y')); ?> Karang Taruna. Made with <iconify-icon icon="mdi:heart" class="text-red-500"></iconify-icon> for Indonesian Youth
                </p>
...
</html><?php /**PATH C:\xampp\htdocs\projectsempro - Copy\resources\views/layouts/app.blade.php ENDPATH**/ ?>