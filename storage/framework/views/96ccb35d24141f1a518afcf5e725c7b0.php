...
<head>
    <meta charset="UTF-8">
    <title>Laporan Hasil Kuisioner SUS - <?php echo e(date('Y-m-d')); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="header">
        ...
        <p>Karang Taruna | <?php echo e(now()->format('d F Y, H:i')); ?></p>
    </div>
    ...
    <div class="summary">
        <div class="summary-card">
            ...
            <div class="value"><?php echo e($totalResponden); ?></div>
            <div class="label">Orang</div>
        </div>
        <div class="summary-card">
            <h3>Rata-rata Skor SUS</h3>
            <div class="value"><?php echo e($rataRataSkor); ?></div>
            <div class="label">Dari skala 0-100</div>
        </div>
        <div class="summary-card">
            <h3>Kelayakan</h3>
            <div class="value">
                <?php if($rataRataSkor >= 68): ?>
    ...
    <div class="kategori-section">
        ...
        <div class="kategori-grid">
            <div class="kategori-item excellent">
                ...
                <div class="count"><?php echo e($kategoriCount['A - Excellent']); ?></div>
            </div>
            <div class="kategori-item good">
                <div class="grade">B</div>
                <div class="label">Good</div>
                <div class="count"><?php echo e($kategoriCount['B - Good']); ?></div>
            </div>
            <div class="kategori-item average">
                <div class="grade">C</div>
                <div class="label">Average</div>
                <div class="count"><?php echo e($kategoriCount['C - Average']); ?></div>
            </div>
            <div class="kategori-item poor">
                <div class="grade">D</div>
                <div class="label">Poor</div>
                <div class="count"><?php echo e($kategoriCount['D - Poor']); ?></div>
            </div>
            <div class="kategori-item worst">
                <div class="grade">F</div>
                <div class="label">Worst</div>
                <div class="count"><?php echo e($kategoriCount['F - Worst']); ?></div>
            </div>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $hasilSus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                <td class="text-center"><?php echo e($loop->iteration); ?></td>
                <td><?php echo e($item->nama); ?></td>
                <td><?php echo e($item->email); ?></td>
                <td class="text-center"><?php echo e($item->usia); ?></td>
                <td><?php echo e($item->pendidikan); ?></td>
                <td><?php echo e($item->pengalaman_komputer); ?></td>
                <td class="text-center"><?php echo e($item->q1); ?></td>
                <td class="text-center"><?php echo e($item->q2); ?></td>
                <td class="text-center"><?php echo e($item->q3); ?></td>
                <td class="text-center"><?php echo e($item->q4); ?></td>
                <td class="text-center"><?php echo e($item->q5); ?></td>
                <td class="text-center"><?php echo e($item->q6); ?></td>
                <td class="text-center"><?php echo e($item->q7); ?></td>
                <td class="text-center"><?php echo e($item->q8); ?></td>
                <td class="text-center"><?php echo e($item->q9); ?></td>
                <td class="text-center"><?php echo e($item->q10); ?></td>
                <td class="text-center">
                    <strong class="<?php echo e($item->sus_score >= 68 ? 'score-high' : ($item->sus_score >= 51 ? 'score-medium' : 'score-low')); ?>">
                        <?php echo e(number_format($item->sus_score, 1)); ?>
                ...
                <td class="text-center">
                    ...
                    ?>
                    <span class="grade-badge <?php echo e($gradeClass); ?>"><?php echo e($grade); ?></span>
                </td>
            </tr>
...
<?php /**PATH C:\xampp\htdocs\projectsempro\resources\views/admin/sus/export-pdf.blade.php ENDPATH**/ ?>