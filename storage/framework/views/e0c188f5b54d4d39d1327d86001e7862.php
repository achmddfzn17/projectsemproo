...
<?php $__env->startSection('title', 'Tentang Kami - Karang Taruna'); ?>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-10">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white rounded-2xl shadow-xl p-8 text-center border border-blue-100">
            <div class="text-6xl font-extrabold text-blue-600 mb-2"><?php echo e($totalAnggota); ?></div>
            <div class="text-gray-700 font-semibold text-lg">Anggota Aktif</div>
        </div>
        <div class="bg-white rounded-2xl shadow-xl p-8 text-center border border-blue-100">
            <div class="text-6xl font-extrabold text-blue-600 mb-2"><?php echo e($totalKegiatan); ?></div>
            <div class="text-gray-700 font-semibold text-lg">Kegiatan Terlaksana</div>
        </div>
        <div class="bg-white rounded-2xl shadow-xl p-8 text-center border border-blue-100">
            <div class="text-6xl font-extrabold text-blue-600 mb-2"><?php echo e($totalProgram); ?></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\projectsempro - Copy\resources\views/tentang.blade.php ENDPATH**/ ?>