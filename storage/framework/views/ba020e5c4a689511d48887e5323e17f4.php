...
<div class="mb-8 bg-gradient-to-r from-purple-600 to-purple-700 rounded-2xl p-8 text-white shadow-xl">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <a href="<?php echo e(route('admin.users.create')); ?>" class="bg-white text-purple-700 hover:bg-purple-50 rounded-xl px-5 py-2.5 text-sm font-semibold transition-all inline-flex items-center gap-2 shadow-lg">
    ...
    <div class="bg-white rounded-xl p-5 shadow-lg border border-purple-100">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-extrabold mt-1 text-purple-600"><?php echo e($users->total()); ?></p>
            </div>
    ...
    <div class="bg-white rounded-xl p-5 shadow-lg border border-purple-100">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-extrabold mt-1 text-purple-600"><?php echo e($users->count()); ?></p>
            </div>
            <div class="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center">
    ...
    <div class="bg-white rounded-xl p-5 shadow-lg border border-purple-100">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xl font-extrabold mt-1 text-purple-600 truncate"><?php echo e(auth()->user()->name); ?></p>
            </div>
            <div class="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center">
        ...
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr class="border-b border-blue-50 hover:bg-blue-50 transition-colors">
                    <td class="py-4 px-6 text-gray-600"><?php echo e($users->firstItem() + $index); ?></td>
                    <td class="py-4 px-6">
                    ...
                    <td class="py-4 px-6 text-sm text-gray-600"><?php echo e($user->email); ?></td>
                    <td class="py-4 px-6 text-sm text-gray-600"><?php echo e($user->created_at->format('d M Y')); ?></td>
                    <td class="py-4 px-6">
                        <div class="flex justify-center space-x-2">
                            <a href="<?php echo e(route('admin.users.edit', $user->id)); ?>" class="bg-blue-50 text-blue-600 px-4 py-2 rounded-xl hover:bg-blue-100 transition font-semibold text-sm inline-flex items-center gap-1">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\projectsempro\resources\views/admin/users/index.blade.php ENDPATH**/ ?>