...
<?php $__env->startSection('title', 'Berita - Karang Taruna'); ?>
    ...
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-blue-100">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-0">
            ...
            <div class="p-10 flex flex-col justify-center">
                ...
                <a href="<?php echo e(route('berita.detail', $featured->slug)); ?>" class="inline-flex items-center text-blue-600 hover:text-blue-700 font-bold text-lg group">
                    Baca Selengkapnya
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
    <div class="flex justify-between items-center mb-12">
        ...
        <div class="text-sm text-gray-600">
            Menampilkan <?php echo e($berita->count()); ?> dari <?php echo e($berita->total()); ?> berita
        </div>
    </div>
    
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <?php $__empty_1 = true; $__currentLoopData = $berita->skip(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <article class="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-blue-100">
            ...
            <div class="p-6">
                ...
                <!-- Read More -->
                <a href="<?php echo e(route('berita.detail', $item->slug)); ?>" class="inline-flex items-center text-blue-600 hover:text-blue-700 font-bold group-hover:gap-2 transition-all">
                    Baca Selengkapnya
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\projectsempro\resources\views/berita/index.blade.php ENDPATH**/ ?>