...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        <form method="POST" action="<?php echo e(route('admin.anggota.update', $anggota->id)); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="username" value="<?php echo e(old('username', $anggota->username)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="nik" value="<?php echo e(old('nik', $anggota->nik)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_lahir"
                        value="<?php echo e(old('tanggal_lahir', $anggota->tanggal_lahir->format('Y-m-d'))); ?>" required
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                ...
                <div>
                    ...
                    <select name="jenis_kelamin" required
                        ...
                        <option value="L" <?php echo e(old('jenis_kelamin', $anggota->jenis_kelamin) == 'L' ? 'selected' : ''); ?>>
                            Laki-laki</option>
                        <option value="P" <?php echo e(old('jenis_kelamin', $anggota->jenis_kelamin) == 'P' ? 'selected' : ''); ?>>
                            Perempuan</option>
                    </select>
                </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="pendidikan_terakhir"
                        value="<?php echo e(old('pendidikan_terakhir', $anggota->pendidikan_terakhir)); ?>" required
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                ...
                <div>
                    ...
                    <select name="status" required
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option value="aktif" <?php echo e(old('status', $anggota->status) == 'aktif' ? 'selected' : ''); ?>>Aktif
                        </option>
                        <option value="non-aktif" <?php echo e(old('status', $anggota->status) == 'non-aktif' ? 'selected' : ''); ?>>
                            Non-Aktif</option>
                    </select>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="alamat" rows="3" required
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('alamat', $anggota->alamat)); ?></textarea>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\projectsempro\resources\views/admin/anggota/edit.blade.php ENDPATH**/ ?>