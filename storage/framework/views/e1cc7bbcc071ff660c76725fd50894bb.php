        ...
        <form action="<?php echo e(route('admin.galeri.update', $galeri->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="judul" value="<?php echo e(old('judul', $galeri->judul)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="nama_kegiatan" value="<?php echo e(old('nama_kegiatan', $galeri->nama_kegiatan)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                        placeholder="Deskripsi atau caption foto..."><?php echo e(old('deskripsi', $galeri->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="urutan" value="<?php echo e(old('urutan', $galeri->urutan)); ?>" min="0"
            ...
            <div class="flex gap-3 mt-6">
                ...
                <a href="<?php echo e(route('admin.galeri.index')); ?>" class="px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold rounded-xl transition-all">
                    Batal
                </a>
            </div>
        </form>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-blue-200 p-6">
        ...
        <div id="preview-container" class="aspect-square rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 overflow-hidden flex items-center justify-center">
            <?php if($galeri->foto): ?>
            <img id="preview-img" src="<?php echo e(asset($galeri->foto)); ?>" alt="<?php echo e($galeri->judul); ?>" class="w-full h-full object-cover">
            <?php else: ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\projectsempro\resources\views/admin/galeri/edit.blade.php ENDPATH**/ ?>