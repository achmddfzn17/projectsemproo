...
<div class="mb-8 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-white shadow-xl">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <a href="<?php echo e(route('admin.galeri.create')); ?>" class="bg-white text-blue-700 hover:bg-blue-50 rounded-xl px-4 py-2 text-sm font-semibold transition-all inline-flex items-center gap-2">
...
<div class="bg-white rounded-2xl shadow-lg border border-blue-200 p-6 mb-6">
    <form action="<?php echo e(route('admin.galeri.index')); ?>" method="GET" class="flex flex-wrap gap-4 items-end">
        <div class="flex-1 min-w-[200px]">
            <label class="block text-sm font-semibold text-gray-700 mb-2">Cari</label>
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari judul foto..."
        ...
        <div class="flex-1 min-w-[200px]">
            ...
            <select name="kegiatan_id" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500">
                ...
                <option value="<?php echo e($kegiatan->id); ?>" <?php echo e(request('kegiatan_id') == $kegiatan->id ? 'selected' : ''); ?>>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
    <?php $__empty_1 = true; $__currentLoopData = $galeris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <div class="bg-white rounded-2xl shadow-lg border border-blue-200 overflow-hidden group hover:shadow-xl transition-all">
        ...
        <div class="relative aspect-square overflow-hidden">
            <?php if($item->foto && file_exists(public_path($item->foto))): ?>
            <img src="<?php echo e(asset($item->foto)); ?>" alt="<?php echo e($item->judul); ?>"
            ...
            <div class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                ...
                <form id="delete-form-<?php echo e($item->id); ?>" action="<?php echo e(route('admin.galeri.destroy', $item->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('DELETE'); ?>
                    <button type="button" onclick="if(confirm('Yakin hapus foto ini?')) document.getElementById('delete-form-<?php echo e($item->id); ?>').submit();"
        ...
        <!-- Info -->
        <div class="p-4">
            <h3 class="font-bold text-gray-800 mb-1 truncate"><?php echo e($item->judul); ?></h3>
            <?php if($item->nama_kegiatan): ?>
            <p class="text-xs text-blue-600 mb-2"><?php echo e($item->nama_kegiatan); ?></p>
            <?php elseif($item->kegiatan): ?>
            <p class="text-xs text-blue-600 mb-2"><?php echo e($item->kegiatan->nama_kegiatan); ?></p>
            <?php endif; ?>
            <?php if($item->deskripsi): ?>
            <p class="text-sm text-gray-500 line-clamp-2"><?php echo e($item->deskripsi); ?></p>
            <?php endif; ?>
            <p class="text-xs text-gray-400 mt-2"><?php echo e($item->created_at->format('d M Y')); ?></p>
        </div>
    </div>
    ...
    <div class="col-span-full">
        <div class="bg-white rounded-2xl shadow-lg border border-blue-200 p-12 text-center">
            ...
            <a href="<?php echo e(route('admin.galeri.create')); ?>" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-xl transition-all">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                </svg>
                Upload Foto
...
<div class="mt-6 bg-white rounded-2xl shadow-lg border border-blue-200 p-6">
    <div class="flex items-center justify-between">
        <span class="text-gray-600">Total Foto: <strong class="text-blue-600"><?php echo e($galeris->total()); ?></strong></span>
        <a href="<?php echo e(route('admin.galeri.create')); ?>" class="text-blue-600 hover:text-blue-700 font-semibold inline-flex items-center gap-1">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\projectsempro\resources\views/admin/galeri/index.blade.php ENDPATH**/ ?>