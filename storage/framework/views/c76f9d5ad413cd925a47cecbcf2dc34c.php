<?php $__env->startSection('title', 'Kuisioner SUS'); ?>
    ...
    <div class="relative z-10">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="flex gap-3">
                <a href="<?php echo e(route('admin.sus.daftar')); ?>" class="flex-1 md:flex-none bg-white/20 hover:bg-white/25 backdrop-blur-sm rounded-2xl px-5 py-3 text-sm font-medium transition-all flex items-center gap-3 hover:shadow-lg transform hover:scale-[1.02]">
...
<div class="sticky top-20 z-20 mb-8 px-4 py-4 bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-blue-100/50">
    ...
    <form action="<?php echo e(route('admin.sus.store')); ?>" method="POST" id="sus-form" class="space-y-8">
        <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama" id="nama" value="<?php echo e(old('nama')); ?>" required
                                class="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all <?php $__errorArgs = ['nama'];
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" id="email" value="<?php echo e(old('email')); ?>" required
                                class="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 bg-red-50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="usia" id="usia" value="<?php echo e(old('usia')); ?>" min="17" max="100" required
                                class="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all <?php $__errorArgs = ['usia'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 bg-red-50 <?php unset($message);
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="pendidikan" id="pendidikan" required
                                class="w-full pl-11 pr-10 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all appearance-none bg-white <?php $__errorArgs = ['pendidikan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 bg-red-50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = ['SMA/SMK', 'D3', 'S1', 'S2', 'S3']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($p); ?>" <?php echo e(old('pendidikan') == $p ? 'selected' : ''); ?>><?php echo e($p); ?></option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <select name="pengalaman_komputer" id="pengalaman_komputer" required
                                class="w-full pl-11 pr-10 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all appearance-none bg-white <?php $__errorArgs = ['pengalaman_komputer'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 bg-red-50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = ['1-6 bulan', '6-12 bulan', '1-3 tahun', '> 3 tahun']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ek): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($ek); ?>" <?php echo e(old('pengalaman_komputer') == $ek ? 'selected' : ''); ?>><?php echo e($ek); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <span class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none">
                                <iconify-icon icon="mdi:chevron-down"></iconify-icon>
                        ...
                        <?php $__errorArgs = ['pengalaman_komputer'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="space-y-5">
            ...
            <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $qNum = $index + 1; $qName = 'q' . $qNum; ?>
                <div class="question-card bg-white p-6 rounded-2xl shadow-md border border-gray-100 hover:shadow-lg hover:border-blue-200 transition-all duration-300" data-question="<?php echo e($qNum); ?>">
                    <div class="flex flex-col lg:flex-row lg:items-center gap-5">
                        ...
                        <div class="flex-1">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <span class="text-xs text-gray-500 font-medium">Pertanyaan <?php echo e($qNum); ?> dari 10</span>
                            </div>
                            <p class="text-gray-800 font-semibold text-base leading-relaxed"><?php echo e($q); ?></p>
                        </div>

                        <!-- Likert Scale -->
                        <div class="flex items-center gap-2">
                            <label class="cursor-pointer group/choice relative flex-1">
                                <input type="radio" name="<?php echo e($qName); ?>" value="1" <?php echo e(old($qName) == 1 ? 'checked' : ''); ?> required class="peer sr-only">
                            ...
                            <label class="cursor-pointer group/choice relative flex-1">
                                <input type="radio" name="<?php echo e($qName); ?>" value="2" <?php echo e(old($qName) == 2 ? 'checked' : ''); ?> required class="peer sr-only">
                            ...
                            <label class="cursor-pointer group/choice relative flex-1">
                                <input type="radio" name="<?php echo e($qName); ?>" value="3" <?php echo e(old($qName) == 3 ? 'checked' : ''); ?> required class="peer sr-only">
                            ...
                            <label class="cursor-pointer group/choice relative flex-1">
                                <input type="radio" name="<?php echo e($qName); ?>" value="4" <?php echo e(old($qName) == 4 ? 'checked' : ''); ?> required class="peer sr-only">
                            ...
                            <label class="cursor-pointer group/choice relative flex-1">
                                <input type="radio" name="<?php echo e($qName); ?>" value="5" <?php echo e(old($qName) == 5 ? 'checked' : ''); ?> required class="peer sr-only">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\projectsempro\resources\views/admin/sus/index.blade.php ENDPATH**/ ?>